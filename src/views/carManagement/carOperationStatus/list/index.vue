...
import { carOperationStatussPage,carOperationStatussDel } from "@/api/modules/carManagement";
import addOrEdit from "../addOrEdit";
import { tbColumnCon } from "./config";
export default {
  name: "carOperationStatuss",
  components: {
    tableCom,
    addOrEdit,
    delModal
  ...
  methods: {
    ...
    async delConfirm (data) {
      ...
      let res = await carOperationStatussDel(data);
      console.log('res',res)
      if (res.status === 204) {
        this.queryList();
      } else {
