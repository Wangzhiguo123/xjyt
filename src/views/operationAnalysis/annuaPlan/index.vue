...
import { processTransactionPage,Create,Deletes,Updates } from "@/api/modules/annuaPlan";
export default {
  name: "Home",
  components: {
    Pages,
      ...
      return {
        ...
        data:{
          ...
          select:[
              ...
              {title:"samplingFileDetails",types:"inputs",},
              {title:"samplingFile",types:"inputs",},
              {title:"samplingYear",types:"inputs",},
          ],
          tableData3:[]
        }
      };
